...
[_RAISE] = LAYOUT(
  ...
  KC_F7,   KC_F8,   KC_F9,   KC_DOT,  KC_EQL,  KC_PIPE, KC_SPACE, KC_DVORAK,  XXXXXXX, KC_PLUS, KC_MINUS, KC_DOT, KC_SLASH, XXXXXXX,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 */
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,     KC_RBRC,KC_N,    KC_M, KC_COMM,  KC_LEFT, KC_DOWN,  KC_RIGHT,
                            KC_LCTL,KC_LCTL, KC_SPC, KC_LALT,     KC_RAISE, KC_ENT, KC_RBRC, KC_MINS
