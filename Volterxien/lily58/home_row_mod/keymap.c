 ...
 */
 ...
 [_GRAPHITE] = LAYOUT(
  ...
  XXXXXXX, HOME_GN,  HOME_GR,  HOME_GT,  HOME_GS,  KC_G,                      KC_Y,    HOME_H,  HOME_GA,  HOME_GE,  HOME_GI,  XXXXXXX,
 ...
 [_SEMIMAK] = LAYOUT(
  ...
  XXXXXXX, HOME_SS,  HOME_GR,  HOME_SN,  HOME_ST,  KC_K,                      KC_C,    HOME_SD,  HOME_SE,  HOME_SA,  HOME_GI,  XXXXXXX,
