...
[_RAISE] = LAYOUT(
  _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
  XXXXXXX, XXXXXXX, LT_GT,   KC_COLN, XXXXXXX, XXXXXXX,                   XXXXXXX, SEMI,    GAMING,  QWERTY,  XXXXXXX, XXXXXXX,
  XXXXXXX, KC_9,    KC_5,    KC_0,    KC_3,    KC_EQL,                    TG_RAI,  KC_2,    KC_1,    KC_4,    KC_8,    XXXXXXX,
  XXXXXXX, XXXXXXX, KC_SLSH, KC_MINS, KC_7,    KC_SPC,  KC_SPC,  XXXXXXX, XXXXXXX, KC_6,    KC_COMM,  KC_DOT,   XXXXXXX, XXXXXXX,
                             _______, _______, _______, _______, _______, _______, _______, _______
),
// /* RAISE
//  * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_SYMS] = LAYOUT(
  ...
  XXXXXXX, KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_SCRL, XXXXXXX, XXXXXXX, XXXXXXX, PREVDIR, HOMEDIR, XXXXXXX, XXXXXXX, XXXXXXX,
                             _______, _______, _______, _______, _______, _______, _______, _______
),
 ...
 */
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    XXXXXXX, KC_LBRC, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_LEFT, KC_DOWN, KC_RIGHT,
